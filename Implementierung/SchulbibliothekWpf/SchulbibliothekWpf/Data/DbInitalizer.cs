        ...
        public static void Initalize() 
        {
            ...
            if (!db.Benutzer.Any())
            {
                db.Benutzer.AddRange(
                    ...
                    new Benutzer { Vorname = "Anna", Nachname = "Müller", Email = "anna@schule.de", Rolle = "Lehrer", PasswortHash = PasswordHelfer.Hash("1235") },
                    new Benutzer { Vorname = "Lena", Nachname = "Schmidt", Email = "lena@schule.de", Rolle = "Schüler", PasswortHash = PasswordHelfer.Hash("1236") },
